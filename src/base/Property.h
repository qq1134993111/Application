...
namespace general
{
    ...
    public:
        ...
        template <typename U>
        std::enable_if_t<!std::is_arithmetic<U>::value, PropertyT&>
        ...
        template <typename U>
        std::enable_if_t<std::is_integral<U>::value, PropertyT&>
        SetValue(const T& key, const U& value)
        {
        ...
        template <typename U>
        std::enable_if_t<std::is_floating_point<U>::value, PropertyT&>
        SetValue(const T& key, const U& value)
        {
        ...
        template <typename U>
        std::enable_if_t<!std::is_arithmetic<U>::value, boost::optional<U>>
        ...
        template <typename U>
        std::enable_if_t<std::is_integral<U>::value, boost::optional<U>>
        GetValue(const T& key) const
        {
            try
            {
        ...
        template <typename U>
        std::enable_if_t<std::is_floating_point<U>::value, boost::optional<U>>
        GetValue(const T& key) const
        {
            try
            {
        ...
        {
            return (prop_any_umap_.count(key));
        }
