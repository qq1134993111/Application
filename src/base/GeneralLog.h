...
namespace general
{
    namespace log_config_key
    {
        ...
        namespace default_value
        {
            ...
            constexpr bool kUseConsoleLoggerValue(false);
            constexpr auto kLoggerThreadModeValue = LoggerThreadMode::kLoggerMt;
            constexpr auto kLoggerTypeValue = LoggerType::kLoggerTypeDaily;
            constexpr bool kBasicTruncateValue(false);
            constexpr size_t kRotatingMaxFileSizeValue(1024 * 1024 * 1024);
            constexpr size_t kRotatingMaxFilesValue(9);
            constexpr int kDailyHourValue(0);
            constexpr int kDailyMinuteValue(0);
            constexpr bool kAsyncModeValue(false);
            constexpr uint32_t kAsyncQueueSizeValue(8092);
            constexpr uint32_t kAsyncThreadCountValue(1);
            constexpr uint32_t kAsyncFlushEveryMicrosecondIntervalValue(100000);
            constexpr uint32_t kBacktraceSizeValue(0);
    ...
    public:
        ...
        static void SetLevel(level_enum log_level)
        {
        ...
        static void FlushOn(level_enum log_level = spdlog::level::trace)
        {
        ...
        static void SetErrorHandler(spdlog_error_handler handler)
        {
        ...
        static void EnableBacktrace(size_t n_messages)
        {
        ...
        static void FlushEvery(std::chrono::duration<Rep, Period> interval)
        {
