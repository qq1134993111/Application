...
namespace general
{
    ...
    int32_t SingletonProcess::Lock()
    {
        ...
        {
            if (is_locked_)
                return static_cast<int32_t>(LockResult::kAlreadyLock);
            ...
            if (!boost::filesystem::exists(dir_path))
            {
                ...
                {
                    return static_cast<int32_t>(LockResult::kCreateFileError);
                }
            }
            ...
            return static_cast<int32_t>(LockResult::kSuccess);
        }
        catch (...)
        {
            LOG_WARN("lock exception:{}", boost::current_exception_diagnostic_information());
            return static_cast<int32_t>(LockResult::kFailure);
        }
    }
}
